...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    public MenuPrincipal(int nivel, String nombre) {
    initComponents();
    lblTitulo.setText("Bienvenido, " + nombre);
    if (nivel != 0) {
    btnUsuarios.setEnabled(false); // bloquea el botón si NO es admin
}
}
    ...
    private void initComponents() {
        ...
        btbMantenimientodept = new javax.swing.JButton();
        ...
        btnUsuarios.setText("Mantenimiento de Usuario");
        ...
        btbMantenimientodept.setText("Mantenimienti de Departaments");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(100, 100, 100)
                        .addComponent(btbMantenimientodept))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(134, 134, 134)
    ...
    private void btnUsuariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUsuariosActionPerformed
       {
    new MantenimientoUsuarios().setVisible(true); // 👈 Abre la ventana
    this.dispose(); // Cierra el menú si quieres
}
    ...
    private javax.swing.JButton btbMantenimientodept;
